...
def start(message):
    ...
    if user_id in BLACK_LIST:
        ...
        bot.send_message(message.chat.id, "Привет! Отправь мне голосовое сообщение или текст в виде вопроса, и я тебе отвечу!(только не задавай глупости,на такое я не умею отвечать)")
    create_database()
